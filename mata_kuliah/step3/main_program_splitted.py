...
from mata_kuliah.step3.algen_matkul_splitted_new import algen_matkul_splitted
import pandas as pd
import  numpy as np
...
step3_mata_kuliah = pd.read_csv('../results/res_step2.csv').to_dict(orient='record')
