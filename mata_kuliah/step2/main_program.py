from mata_kuliah.step2.algen_matkul_new import algen_matkul
from mata_kuliah.step2.algen_matkul_splitted_new import algen_matkul_splitted
import pandas as pd
import  numpy as np
...
step2_mata_kuliah = pd.read_csv('../results/res_step1.csv').to_dict(orient='record')
...
nn_params['mata_kuliah'] = step2_mata_kuliah
